...
public class BebedoresService {
	...
	public Response getBebedoresByCiudadAndPresupuesto(@QueryParam("ciudad")String ciudad,
			@QueryParam("presupuesto")String presupuesto)
	{
	...
	public Response updateBebedor(Bebedor bebedor) {
		//TODO Path Requerimiento 5B: Implemente el metodo a partir de los ejemplos anteriores y utilizando el Transaction Manager de Parranderos 
