...
public class RFC6DAO 
{
	...
	public String RFC6( String id) throws SQLException, Exception {
		...
		String sql1 = String.format("SELECT  SUM(TO_DATE(FECHAFIN, 'DD/MM/YYYY')-TO_DATE(FECHAINICIO, 'DD/MM/YYYY')) AS DIAS FROM %1$s.CONTRATO WHERE ID_CLIENTE='%2$s' AND ESTADO ='Activo'" ,
				USUARIO,id);
		...
		{
			String valor=rs1.getDouble("DIAS")+"";
			rpta+= "Dias: "+ valor +"\n" ;
			
			rpta+= "Gasto: "+ rs2.getDouble("GASTOTOTAL") +"\n";
